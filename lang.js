const i18n = {
    fr: {
        ...
        android_title2: "StuAuth Mobile",
        android_desc2: "Authentificateur TOTP/HOTP local. Pas de cloud, pas de synchronisation, pas de suivi",
        web_title1: "StuAuthWeb",
        web_desc1: "Client local pour StuAuth (Firefox uniquement) Nécessite StuAuthDesktop",
        windows_title1: "Echo",
    ...
    en: {
        ...
        android_title2: "StuAuth Mobile",
        android_desc2: "Local TOTP/HOTP authenticator. No cloud, no sync, no tracking",
        web_title1: "StuAuthWeb",
        web_desc1: "Local client for StuAuth (Firefox only) Requires StuAuthDesktop",
        windows_title1: "Echo",
